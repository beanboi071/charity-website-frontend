            ...
            <div className="w-full h-full relative">
                ...
                <div className="w-[600px] text-white absolute left-[50px] top-[250px]">
                    ...
                    {isDonor ?
                     ...
                     <Link to={"/NGO/Create"} className=" mt-8 rounded-xl hover:bg-[#B6C6A2] ease-in-out duration-200 hover:cursor-pointer w-[300px] h-[75px] bg-secondary flex justify-center items-center">
