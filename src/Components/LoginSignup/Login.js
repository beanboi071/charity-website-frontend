                ...
                <form className="border-solid border-2 border-t-quaternary border-l-quaternary border-b-quaternary p-5 bg-neutral-100 flex items-center sm:rounded-tl-3xl sm:rounded-bl-3xl sm:w-3/5 w-full"
                    ...
                    <div className="w-full" >
                        ...
                        <div className="w-full flex justify-center">
                            <button className="bg-emerald-200 w-full btn pl-3 pr-3 pt-1 pb-1 border-emerald-300 border-solid border-2  mt-4 rounded-full hover:bg-emerald-300 hover:text-white" type="submit">{isSignUp ? "Sign Up" : "Login"}</button>
                        </div>
