...
export const AdminNavbar = ()=>{
    ...
    return(
        <div className="bg-lime-600 h-full w-64 fixed ">
            ...
            <p className="my-4 font-bold text-slate-100 text-xl hover:cursor-pointer" onClick={()=>navigate("/Admin/DonationHistory")}>Donation History</p>
        </div>
